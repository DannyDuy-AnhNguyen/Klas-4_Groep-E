...
public class ItemBoek extends Item{
    ...
    public static void toonInfo(boolean eersteKeer) {
        if (eersteKeer && !storylineGetoond) {
            ...
            TextPrinter.print("Voordat je verder gaat, een korte uitleg over de items die je onderweg zult vinden:");
    ...
    public static void commandoInfo() {
        TextPrinter.print("Je raadpleegt je gids over de items...");
        toonItemUitleg();
    }

    private static void toonItemUitleg() {
        System.out.println();
        TextPrinter.print("- Zwaard: Verslaat elk monster in één klap. Krachtig, maar mogelijk zeldzaam.");
        TextPrinter.print("- Splitter: Je hoeft slechts de helft van de vragen correct te beantwoorden om een monster te verslaan.");
        TextPrinter.print("- Rots: Een zware steen. Hij doet niets... althans, voor zover je weet.");
        System.out.println();
    }
